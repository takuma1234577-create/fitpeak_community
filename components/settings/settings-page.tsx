...
export default function SettingsPage() {
  ...
  function renderAccount() {
    const lineAddUrl = process.env.NEXT_PUBLIC_LINE_OFFICIAL_ADD_URL
    const lineLinkUrl = "/api/auth/line?next=" + encodeURIComponent("/dashboard/settings")
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#06C755]/20">
                <svg className="h-7 w-7 text-[#06C755]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <div>
                <h3 className="text-base font-bold text-foreground">公式LINE連携</h3>
            ...
            <div className="shrink-0">
              {hasLineLinked === true && lineAddUrl ? (
                <a
                  href={lineAddUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#06C755] px-5 py-3 text-sm font-bold text-white shadow-lg shadow-[#06C755]/25 transition-opacity hover:opacity-90"
                >
